...
class TestConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.parsed_config = {'log file path': './rt_movie_cover/config_test/.local/share/imgdb/imgdb.log',
                              'log level': 'warning', 'update frequency': 'weekly',
                              'google search api key': 'AIzaSyANWkWTK4gmJIRHferGPmqCTdffdIT8XFjhk',
                              'imdb custom search id': '32b1e112kdf754be1f'}
        self.yaml_file_content = ("general:\n"
    ...
    def test_parse_config_yaml(self, validate_config):
        ...
        self.assertEqual(parsed_yaml, {'log file path': './rt_movie_cover/config_test/.local/share/imgdb/imgdb.log',
                                       'log level': 'warning', 'update frequency': 'weekly',
                                       'google search api key': 'AIzaSyANWkWTK4gmJIRHferGPmqCTdffdIT8XFjhk',
    ...
    def test_read_config_yaml(self, parse_config_yaml):
        ...
        with patch("builtins.open", mock_open(read_data=yaml_file_mock)) as file_mock:
            ...
            self.assertEqual(reading_mock_file, {'log file path': './rt_movie_cover/config_test/.local/share/imgdb/imgdb.log',
                                                 'log level': 'warning', 'update frequency': 'weekly',
                                                 'google search api key': 'AIzaSyANWkWTK4gmJIRHferGPmqCTdffdIT8XFjhk',
    ...
    def test_validate_config(self):
        ...
        self.assertEqual(validate_config(wrong_config), 0,
